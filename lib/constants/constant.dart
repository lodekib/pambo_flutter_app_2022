...
class Constants {
  ...
  static const TextStyle pambocardTextStyle =
      TextStyle(fontSize: 13, fontWeight: FontWeight.bold);
  static const TextStyle pambocardrateTextStyle = TextStyle(
    color: Colors.grey,
    fontSize: 13,
  );
  static const TextStyle pambosearchtextStyle =
      TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold);

  static List<TabChoice> tabList = <TabChoice>[
    TabChoice(
        category: 'Top',
        image: 'assets/images/icons8-fire-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Fragrance',
        image: 'assets/images/icons8-fragrance-35.png',
        goTo: FragrancelistScreen()),
    TabChoice(
        category: 'Jewellery',
        image: 'assets/images/icons8-earrings-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Makeup',
        image: 'assets/images/icons8-makeup-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Skin Care',
        image: 'assets/images/icons8-cream-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Massage',
        image: 'assets/images/icons8-massage-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Hair Dressing',
        image: 'assets/images/icons8-man-combing-hair-35.png',
        goTo: const HomeScreen()),
    TabChoice(
        category: 'Braids & Wigs',
        image: 'assets/images/icons8-hair-curler-35.png',
        goTo: const HomeScreen())
  ];
