                                  ...
                                  itemBuilder: (context, itemIndex,
                                      ...
                                      Container(
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          imageUrl:
                                              'https://img.search.brave.com/0Phbn0ycrNwDONqWQGJv_lNJc-8it55i87fHfmc2Zy0/rs:fit:1200:1200:1/g:ce/aHR0cDovL3d3dy5z/bnV0LmZyL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDE1LzA4L2lt/YWdlLWRlLXBheXNh/Z2UuanBn',
                                                        ...
                                                        : ScaffoldMessenger.of(
                                                            ...
                                                            padding:
                                                                EdgeInsets.all(
                                                                    8),
                                                            content: Text(
                                                                'Unable to launch Whatsapp Messenger'),
                                                          ));
                                                  },
                                                  child: Image.asset(
                                              ...
                                              child: OutlinedButton(
                                                  onPressed: () {
                                                    final Uri emailUri = Uri(
                                                        scheme: 'mailto',
                                                        path:
                                                            'brianmlodeki@gmail.com',
                                                        query: json.encode(<
                                                            String, String>{
                                                          'subject':
                                                              'Legal Issue to Pambo'
                                                        }));
