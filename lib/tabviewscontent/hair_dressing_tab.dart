      ...
      builder: (context,snapshot){
        switch(snapshot.connectionState){
          ...
          case ConnectionState.done:
            Map<String,dynamic> hairdressings = snapshot.data as Map<String,dynamic> ;
                ...
                itemBuilder: (BuildContext context, int index){
                  return Card(
                      ...
                      child:ListTile(
                        ...
                        subtitle:  Text(countHairdressings(hairdressings.values, index),style: const TextStyle(fontSize: 13),),
                        ...
                        onTap: () async{
                          ...
                          await Navigator.push(context,
                              MaterialPageRoute(
                                  builder:(_)=>
                                      CategoricalViews(
                                          subcategory: hairdressings.keys.elementAt(index),
                                          data: hairdressingsToModel(hairdressings.values.elementAt(index)))))
