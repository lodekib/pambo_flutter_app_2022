...
class JewellerylistScreen extends StatelessWidget {
  ...
  List<DataModel> jewelsToModel(List<dynamic> jewelsToConvert) {
    return jewelsToConvert
        .map((jewelerry) => DataModel.fromJson(jewelerry))
        .toList();
  }
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                              countJewels(jewels.values, index),
                                  ...
                                  ? await Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => CategoricalViews(
                                              subcategory:
                                                  jewels.keys.elementAt(index),
                                              data: jewelsToModel(jewels.values
                                                  .elementAt(index)))))
