...
class MakeuplistScreen extends StatelessWidget {
  ...
  List<DataModel> makeupsToModel(List<dynamic> makeupsToConvert) {
    return makeupsToConvert
        .map((makeup) => DataModel.fromJson(makeup))
        .toList();
  }
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                              countMakeups(makeups.values, index),
                                  ...
                                  ? await Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => CategoricalViews(
                                              subcategory:
                                                  makeups.keys.elementAt(index),
                                              data: makeupsToModel(makeups
                                                  .values
                                                  .elementAt(index)))))
